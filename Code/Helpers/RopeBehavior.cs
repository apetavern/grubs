...
public sealed class RopeBehavior : Component
{
	...
	[Property] private LineRenderer RopeRenderer { get; set; }
	...
	private void DrawRope()
	{
		...
		{
			case > 1:
				RopeRenderer.VectorPoints.Clear();
				RopeRenderer.VectorPoints.Add( HookObject.WorldPosition );
				RopeRenderer.VectorPoints.AddRange( CornerObjects );
				break;
			case 1:
				RopeRenderer.VectorPoints.Clear();
				RopeRenderer.VectorPoints.Add( HookObject.WorldPosition );
				RopeRenderer.VectorPoints.Add( CornerObjects[0] );
				break;
			default:
				RopeRenderer.VectorPoints.Clear();
				RopeRenderer.VectorPoints.Add( HookObject.WorldPosition );
		...
		RopeRenderer.VectorPoints.Add( MuzzlePoint.WorldPosition );
	}
}
