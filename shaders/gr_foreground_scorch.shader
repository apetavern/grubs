...
PS
{
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float4 local6 = saturate( lerp( local4, local4*local3, local5.a ) );
		...
		float4 local23 = lerp( local3, local6, local22 );
		float4 local24 = lerp( local14, local23, 0.5 );
		float4 local25 = g_bGradientTint ? local24 : local6;
