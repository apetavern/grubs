...
PS
{
	...
	CreateInputTexture2D( Colour, Srgb, 8, "None", "_color", ",0/,0/0", DefaultFile( "textures/environment/sand_shells_color.png" ) );
	CreateInputTexture2D( BlendMask, Linear, 8, "None", "_mask", ",0/,0/0", DefaultFile( "textures/environment/sand_shells_blend.png" ) );
	CreateInputTexture2D( ScorchColour, Srgb, 8, "None", "_color", ",0/,0/0", DefaultFile( "textures/environment/rocks_a_color.png" ) );
	CreateInputTexture2D( ScorchBlendMask, Linear, 8, "None", "_mask", ",0/,0/0", DefaultFile( "textures/environment/lava_rocks_selfillum.png" ) );
	CreateInputTexture2D( Normal, Linear, 8, "NormalizeNormals", "_normal", ",0/,0/0", DefaultFile( "textures/environment/sand_shells_normal.png" ) );
	CreateInputTexture2D( ScorchNormal, Linear, 8, "NormalizeNormals", "_normal", ",0/,0/0", DefaultFile( "textures/environment/lava_rocks_normal.png" ) );
	CreateInputTexture2D( Rough, Linear, 8, "None", "_rough", ",0/,0/0", DefaultFile( "textures/environment/sand_shells_rough.png" ) );
	CreateInputTexture2D( ScorchRough, Linear, 8, "None", "_rough", ",0/,0/0", DefaultFile( "textures/environment/lava_rocks_rough.png" ) );
	CreateInputTexture2D( AO, Linear, 8, "None", "_ao", ",0/,0/0", DefaultFile( "textures/environment/sand_shells_ao.png" ) );
	CreateInputTexture2D( ScorchAO, Linear, 8, "None", "_ao", ",0/,0/0", DefaultFile( "textures/environment/lava_rocks_ao.png" ) );
	...
	TextureAttribute( LightSim_DiffuseAlbedoTexture, g_tScorchBlendMask )
	TextureAttribute( RepresentativeTexture, g_tScorchBlendMask )
	...
	float4 g_vScorchLayer_Params < Attribute( "ScorchLayer_Params" ); Default4( 0.00, 0.00, 1.00, 64.00 ); >;
