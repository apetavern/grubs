...
PS
{
	...
	CreateInputTexture2D( Colour, Srgb, 8, "None", "_color", "Textures,3/,0/0", DefaultFile( "materials/dev/white_color.tga" ) );
	CreateInputTexture2D( BlendMask, Linear, 8, "None", "_mask", ",0/,0/0", DefaultFile( "materials/dev/white_color.tga" ) );
	CreateInputTexture2D( Normal, Linear, 8, "NormalizeNormals", "_normal", "Textures,3/,0/0", DefaultFile( "materials/dev/white_color.tga" ) );
	CreateInputTexture2D( Rough, Linear, 8, "None", "_rough", "Textures,3/,0/0", DefaultFile( "materials/dev/white_color.tga" ) );
	CreateInputTexture2D( AO, Linear, 8, "None", "_ao", "Textures,3/,0/0", DefaultFile( "materials/dev/white_color.tga" ) );
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float3 l_28 = Vec3OsToTs( l_27, i.vNormalOs.xyz, i.vTangentUOs_flTangentVSign.xyz, cross( i.vNormalOs.xyz, i.vTangentUOs_flTangentVSign.xyz ) * i.vTangentUOs_flTangentVSign.w );
