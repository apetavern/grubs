...
[Prefab]
public partial class TorchComponent : WeaponComponent
{
	[Prefab, Net]
	...
	[Prefab, Net]
	public float ExplosionRadius { get; set; } = 16f;
	...
	public override void FireInstant()
	{
		...
		var endPos = muzzle is not null
			? startPos + muzzle.Value.Rotation.Forward * TraceDistance
			: startPos + Grub.EyeRotation.Forward * TraceDistance;
		var pitch = Grub.EyeRotation.Pitch();
		//pitch *= -Grub.Facing;
